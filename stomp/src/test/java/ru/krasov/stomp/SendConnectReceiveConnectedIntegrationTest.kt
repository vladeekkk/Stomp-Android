...
internal class SendConnectReceiveConnectedIntegrationTest {
    ...
    private val clientConfiguration by lazy {
        OkHttpStompClientConfiguration(
                ...
                if (request.path.equals("/")) {
                    return MockResponse().withWebSocketUpgrade(object : WebSocketListener() {
                        ...
                        override fun onMessage(webSocket: WebSocket, text: String) {
                            ...
                            webSocket.send(CONNECTED_FRAME)
                            println("Server sent CONNECTED frame")
                        }
                    })
                }
...
//        mockWebServer.shutdown()
    ...
    @Test
    fun `send CONNECT and receive CONNECTED message`() = runTest(testDispatcher) {
