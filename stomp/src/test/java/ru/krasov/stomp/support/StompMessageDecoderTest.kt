...
class StompMessageDecoderTest {
    ...
    @Test
    fun `decode correct connected frame`() {
        val accept = "accept-version:1.1\n"
        val message = decode("CONNECTED\n$accept\n\u0000")
    ...
    @Test
    fun `decode correct error frame`() {
        val receipt = "receipt-id:message-12345\n"
        val contentType = "content-type:text/plain\n"
        val payload = "\nSadge.\n"
        val message = decode("ERROR\n$receipt$contentType$payload\n\u0000")
